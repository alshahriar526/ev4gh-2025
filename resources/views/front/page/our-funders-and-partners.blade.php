                ...
                <div class="row justify-content-center gy-4">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/CBD_logo_EN_RGB.jpg') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/ITM-logo_col_pms.png') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/Mohammad Bin Rashid.png') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/Nagasaki University.jpg') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/Universidad de Antioquia.png') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/Liverpool_School_of_Tropical_Medicine_Logo.png') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/UWC_logo.svg.png') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/Peking University.png') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/cpi-logo_v_square_696x696_rgb.png') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/BMJ- logo.jpeg') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/IPH-logo-100px.png') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/APHRC-logo.png') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/BRACJPGSPH_New-logo.png') }}"
                                alt="">
                    ...
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="partner-box">
                            <img class="img-fluid"
                                src="{{ asset('assets/images/about/Logos-Partner Institutes/Logo-HSG-Colour-1.svg') }}"
                                alt="">
        ...
        <div class="container">
            <div class="row p-5">
                <p>We remain grateful to all individuals and teams within these organisations who have accompanied
                    ...
                    discourse.</p>
                <p><em>The logos of our funders and partners are displayed above as a visual acknowledgement of their
                        contribution to the EV4GH journey.</em></p>
            </div>
        </div>
    </main>
@endsection
