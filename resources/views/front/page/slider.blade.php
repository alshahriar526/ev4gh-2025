 <div class="swiper-container main-slider">
     <div class="swiper-wrapper">
         ...
         <div class="swiper-slide">
             ...
             <div class="background"
                 style="background-image: url(assets/images/index/slider/2026-Fellowship.jpg);">
             </div>
         </div>

         <div class="swiper-slide">
             <div class="content slider-style-default">
                 <h1 style="color: #d21b22;">EV4GH Appoints Germán Alarcón Garavito and Soe Yu Naing as Governance Board Co-Chairs</h1>
                 <p></p>
                 <a class="btn" target="_blank"
             ...
             <div class="background"
                 style="background-image: url(assets/images/index/slider/Board-Co-Chairs.jpg);">
             </div>
         </div>
         ...
         <div class="swiper-slide">
             ...
             <div class="background"
                 style="background-image: url(assets/images/index/slider/ev-2026-venture.jpg);">
             </div>
         </div>
