        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between h-100">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown">
                        <a href="#"
                            class="{{ request()->is('about*') || request()->routeIs('gb_members.*') || request()->routeIs('our-funders-and-partners') ? 'active' : '' }}">
                            <span>About</span> <i class="bi bi-chevron-down dropdown-indicator"></i>
                        </a>
                        <ul>
                            <li><a href="{{ url('/about') }}" class="{{ request()->is('about') ? 'active' : '' }}">Our
                                    History</a></li>
                            <li><a href="{{ route('gb_members.index') }}"
                                    class="{{ request()->routeIs('gb_members.*') ? 'active' : '' }}">Governance Board
                                    Members</a></li>
                            <li><a href="{{ route('our-funders-and-partners') }}"
                                    class="{{ request()->routeIs('our-funders-and-partners') ? 'active' : '' }}">Our
                                    Funders & Partners</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul>
                            ...
                            <li><a target="_blank" rel="noopener"
                                    href="{{ asset('assets/pdf/ev-10th-anniversary/EV-2020-magazine.pdf') }}">EV
                                    Digital Magazine</a></li>
                            <li><a target="_blank" rel="noopener"
                                    href="{{ asset('assets/pdf/ev-10th-anniversary/EV4GH-Evaluation-Exec-Summary.pdf') }}">Executive
                                    Summary</a></li>
                            <li><a target="_blank" rel="noopener"
                                    href="{{ asset('assets/pdf/ev-10th-anniversary/EV4GH-Evaluation-Report-FINAL_optimize.pdf') }}">Full
                    ...
                    <li>
                        <a href="{{ route('call-for-applications-2026') }}"
                            class="{{ request()->routeIs('call-for-applications-2026') ? 'active' : '' }}">
                    ...
                    <li class="dropdown">
                        ...
                        <ul>
                            <li><a href="{{ route('past-venture.2022') }}"
                                    class="{{ request()->routeIs('past-venture.2022') ? 'active' : '' }}">EV4GH
                                    2022</a></li>
                            <li><a href="{{ route('past-venture.2018') }}"
                                    class="{{ request()->routeIs('past-venture.2018') ? 'active' : '' }}">EV4GH
                                    2018</a></li>
                            <li><a target="_blank" rel="noopener" href="https://old.ev4gh.net/programme/">EV4GH 2016</a>
                            </li>
                            <li><a target="_blank" rel="noopener"
                                    href="https://old.ev4gh.net/past-editions/2014-2/">EV4GH 2014</a></li>
                            <li><a target="_blank" rel="noopener"
                                    href="https://old.ev4gh.net/past-editions/2013-2/">EV4GH 2013</a></li>
                            <li><a target="_blank" rel="noopener"
                                    href="https://old.ev4gh.net/past-editions/2012-2/">EV4GH 2012</a></li>
                            <li><a target="_blank" rel="noopener"
                                    href="https://old.ev4gh.net/past-editions/2010-2/">EV4GH 2010</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('newsletter') }}"
                            class="{{ request()->routeIs('newsletter') ? 'active' : '' }}">
