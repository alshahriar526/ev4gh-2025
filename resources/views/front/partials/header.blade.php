...
<header id="header" class="header d-flex align-items-center fixed-top">
    ...
    <a href="index.php" class="logo d-flex align-items-center h-100">
       
        <img src="assets/images/logo/EV4GH-NEW-Logo.png" alt="Ev4gh logo" />
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <path fill="#E40000" d="M41,23.7C27.5,47.1,-26.8,46.9,-40.4,23.5C-54,0.1,-27,-46.5,0.1,-46.4C27.3,-46.4,54.5,0.4,41,23.7Z" transform="translate(100 100)" />
</svg>
    </a>
    <nav id="navbar" class="navbar">
        ...
        <li class="dropdown"><a href="#"><span>About</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
         ...
         <li><a href=""><span>Call for Applications 2026</span></a></li>
